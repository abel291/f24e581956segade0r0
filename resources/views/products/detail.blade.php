...
@section('seo_keys',$product->seo_keys )
                ...
                <div class="single-product">
                    <div class="images">
                        ...
                        <div class="slider-for">
                            ...
                            <div>
                                <a  href="{{$image->img}}" data-lightbox="image-1" data-title="{{$product->title}}">
                                    <img src="{{$image->thum}}"  style="width: 100%" class="img-responsive" alt="{{$product->category_name}} {{$product->title}}" title="{{$product->category_name}} {{$product->title}}">
                                </a> 
                            </div>                                            
                            @endforeach                                         
                        </div>
                        <div class="slider-nav">
                            @foreach($product->images as $image)                                           
                            <div>                                       
                                <img src="{{$image->thum}}" class="img-responsive" 
                                alt="{{$product->category_name}} {{$product->title}}" 
                    ...
                    <div class="summary">
                        ...
                        <div class="add-to-cart-form">
                            <form class="cart" action="{{route('add')}}" method="post">
                                ...
                                <button type="submit" class="single_add_to_cart_button button">Reservar</button>
